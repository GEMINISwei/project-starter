...
```bash
git clone <模板位置> my-project && cd my-project
git remote rename origin template   # 把模板留成可持續拉更新的上游
...
| 在下游專案工作：哪些目錄不能改、怎麼拉模板更新 | [`docs/downstream.md`](docs/downstream.md) |
...
| 模板本身的變更紀錄 | [`CHANGELOG.md`](CHANGELOG.md) |
